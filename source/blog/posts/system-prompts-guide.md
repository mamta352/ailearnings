...
**How do I write a refusal instruction that produces a good user experience?**
...
**Should task-specific instructions go in the system prompt or the user message?**
Put stable operating rules in the system prompt and task-specific context in the user message. If an instruction applies to 100% of requests, it belongs in the system prompt. If it applies to only one specific request type, inject it in the user message to avoid wasting tokens on every call.

---

## What to Learn Next

- [Prompt Templates for AI Applications](/blog/prompt-templates/) — structure and version your system prompts as engineering artifacts with a registry
- [Prompt Injection Attacks and How to Prevent Them](/blog/prompt-injection/) — understand the attacks your system prompt defenses need to withstand
- [Role Prompting Explained](/blog/role-prompting/) — design the persona section of your system prompt with specificity that shifts output quality
- [Prompt Engineering Best Practices](/blog/prompt-engineering-best-practices/) — evaluate, version, and monitor system prompts in production
- [Prompt Engineering Mistakes](/blog/prompt-engineering-mistakes/) — common system prompt design errors and how to fix them
